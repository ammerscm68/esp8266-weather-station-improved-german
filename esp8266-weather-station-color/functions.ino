...
gfx.clear();
  ...
  gfx.drawString(120, 90, "Wetterstation");
  // gfx.drawString(120, 90, "https://thingpulse.com");  
gfx.drawString(120, 160, "Wetterstation Zurücksetzen");  
gfx.drawString(120, 180, "(Berühren = Abbruch!)");
gfx.drawString(120, 270, "Start WiFiManager bei 0:");
...
if (WSReset <= 0 && screen == 5) {Serial.print("Reset Wetterstation !"); ResetWeatherStation();}  
}
